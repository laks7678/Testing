...
query11 = "CREATE TABLE #ABC_T_TGT_ACCOUNT_SUMMERY_TEMP ,FALLBACK , CHECKSUM = DEFAULT, DEFAULT MERGEBLOCKRATIO, LOG ( ACCOUNT_ID BIGINT NOT NULL, SRC_ACCOUNT_NO DECIMAL(18,4) NOT NULL, ACCOUNT_TYPE_CD CHAR(15) CHARACTER SET LATIN NOT CASESPECIFIC NOT NULL, ACCOUNT_SOURCE_CD CHAR(10) CHARACTER SET LATIN UPPERCASE NOT CASESPECIFIC, ACCOUNT_CURRENT_STATUS_TYPE_CD CHAR(20) CHARACTER SET LATIN NOT CASESPECIFIC, DISPOSITION_CD CHAR(1) CHARACTER SET LATIN NOT CASESPECIFIC, ACCOUNT_BAL_AMT DECIMAL(38,8), ACCOUNT_OPEN_DTTM DATETIME2(0), ACCOUNT_CLOSE_DTTM DATETIME2(4), ACCOUNT_NAME VARCHAR(1000) CHARACTER SET UNICODE NOT CASESPECIFIC, ACCOUNT_DESC_TXT VARCHAR(20000) CHARACTER SET UNICODE NOT CASESPECIFIC, ETL_INS_DTTM DATETIME2(6), ETL_UPD_DTTM DATETIME2(6), BATCH_ID DECIMAL(18,0) NOT NULL)PRIMARY CHARINDEX ( ACCOUNT_ID )ON COMMIT DELETE ROWS"
cursor = connection.cursor()
